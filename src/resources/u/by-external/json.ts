...
export class Json extends APIResource {
  ...
  retrieve(
    ...
    return this._client.get(path`/u/by-external/${externalID}.json`, {
      ...options,
  ...
  retrieveByProvider(
    externalID: string,
    params: JsonRetrieveByProviderParams,
    options?: RequestOptions,
  ): APIPromise<JsonRetrieveByProviderResponse> {
    const { provider, 'Api-Username': apiUsername } = params;
    return this._client.get(path`/u/by-external/${provider}/${externalID}.json`, {
      ...options,
      headers: buildHeaders([{ 'Api-Username': apiUsername }, options?.headers]),
    });
  }
...
export interface JsonRetrieveResponse {
  user: JsonRetrieveResponse.User;
...
export namespace JsonRetrieveResponse {
  export interface User {
    ...
    group_users: Array<User.GroupUser>;
    ...
    user_auth_tokens: Array<User.UserAuthToken>;

    user_notification_schedule: User.UserNotificationSchedule;

    user_option: User.UserOption;
...
export interface JsonRetrieveByProviderResponse {
  user: JsonRetrieveByProviderResponse.User;

  user_badges: Array<unknown>;
}

export namespace JsonRetrieveByProviderResponse {
  export interface User {
    id: number;
...
export interface JsonRetrieveByProviderParams {
  /**
   * Path param: Authentication provider name. Can be found in the provider callback
