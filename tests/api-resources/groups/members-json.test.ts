...
describe('resource membersJson', () => {
  // skipped: tests are disabled for the time being
  test.skip('list', async () => {
    const responsePromise = client.groups.membersJson.list('name');
  ...
  // skipped: tests are disabled for the time being
  test.skip('add', async () => {
    const responsePromise = client.groups.membersJson.add(0);
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('remove', async () => {
    const responsePromise = client.groups.membersJson.remove(0);
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('remove: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.groups.membersJson.remove(
        0,
        { usernames: 'username1,username2' },
        { path: '/_stainless_unknown_path' },
      ),
