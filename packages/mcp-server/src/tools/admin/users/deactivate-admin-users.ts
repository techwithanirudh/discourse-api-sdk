...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'put',
  httpPath: '/admin/users/{id}/deactivate.json',
  operationId: 'deactivateUser',
};

export const tool: Tool = {
  name: 'deactivate_admin_users',
  description:
...
export const handler = async (client: DiscourseSDK, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(args, await client.admin.users.deactivate(id)));
};
