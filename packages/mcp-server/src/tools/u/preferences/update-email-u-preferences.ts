...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'put',
  httpPath: '/u/{username}/preferences/email.json',
  operationId: 'updateEmail',
};

export const tool: Tool = {
  name: 'update_email_u_preferences',
  description:
...
export const handler = async (client: DiscourseSDK, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.u.preferences.updateEmail(username, body).asResponse();
