...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/session/forgot_password.json',
  operationId: 'sendPasswordResetEmail',
};

export const tool: Tool = {
  name: 'send_forgot_password_email_session',
  description:
...
export const handler = async (client: DiscourseSDK, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(args, await client.session.sendForgotPasswordEmail(body)));
};
