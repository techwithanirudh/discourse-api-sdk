...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'put',
  httpPath: '/notifications/mark-read.json',
  operationId: 'markNotificationsAsRead',
};

export const tool: Tool = {
  name: 'mark_read_notifications',
  description:
...
export const handler = async (client: DiscourseSDK, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(args, await client.notifications.markRead(body)));
};
