...
import { ClientOptions } from 'discourse-api-sdk';
...
export { ClientOptions } from 'discourse-api-sdk';
...
export function initMcpServer(params: {
  ...
  const client = new DiscourseSDK(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client = params.client || new DiscourseSDK({ defaultHeaders: { 'X-Stainless-MCP': 'true' } });
